                                ...
                                <tbody>
                                    <?php
							    		...
							    		foreach ($entries as $module) {
                                            $balance += ($module["purchase_price"] * $module['stock_in_hand']);
							    	?>
                                        <tr>
                                            <td>
                                                <?php echo $module["id"] ?>
                                            ...
                                            <td>
                                                <?php echo $module["purchase_price"] ?>
                                            </td>
                                            <td>
                                                <?php echo $module["stock_in_hand"] ?>
                                            </td>
                                            <td>
                                                <?php echo ($module["purchase_price"] * $module['stock_in_hand']) ?>
                                            </td>
                                        </tr>
                                    <?php 
